...
export function success_hours_summary( data ){
	return createAction( ACTION_SUCCESS_HOURS_SUMMARY )( data )
}

export function empty_hours_summary( data ){
	return createAction( ACTION_EMPTY_HOURS_SUMMARY )( data )
}

export function error_hours_summary( data ){
	return createAction( ACTION_ERROR_HOURS_SUMMARY )( data )
}
...
export function empty_update_hours_summary( data ){
	return createAction( ACTION_EMPTY_UPDATE_HOURS_SUMMARY )( data )
}

export function error_update_hours_summary( data ){
	return createAction( ACTION_ERROR_UPDATE_HOURS_SUMMARY )( data )
}
