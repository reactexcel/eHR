...
export const REQUEST_GET_TEAM = 'ACTION_REQUEST_GET_TEAM';
export const SUCCESS_GET_TEAM = 'ACTION_SUCCESS_GET_TEAM';
export const ERROR_GET_TEAM = 'ACTION_ERROR_GET_TEAM';
