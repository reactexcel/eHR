...
export const CONFIG = {
  ...
  LEAVE_DAY: 'LEAVE_DAY',
  //dev apis
  api_url: 'http://hr.excellencetechnologies.in/attendance/API_HR/api.php',
  other_api_url: 'http://hr.excellencetechnologies.in/attendance/sal_info/api.php',
  api_url_salary: 'http://hr.excellencetechnologies.in/attendance/sal_info',
  google_login_btn_page_url: "http://hr.excellencetechnologies.in/attendance/sal_info/google-api/drive_file/index.php?token=" + token,
  login_page_url: "http://hr.excellencetechnologies.in/",
  upload_url: "http://hr.excellencetechnologies.in/attendance/sal_info/upload_file.php",
