  ...
  render () {
    ...
    let mainDivs = <div className="row">
      <div className="col-md-3">
        <UsersList disabledUser users={disabled_users} selectedUserId={this.state.selected_user_id} onUserClick={this.onUserClick} {...this.props} />
      </div>
        ...
        <div className="box">
          <div className="box-body">
            <div className="row">
              ...
              <div className="col-md-6">
                <UpdateEmployeeDocument disabled user_documents={this.state.user_documents} user_id={this.state.selected_user_id} onUpdatedocuments={this.props.onUpdatedocuments} {...this.props} />
              </div>
            </div>
          </div>
        </div>
    ...
    return (
      <div>
        ...
        <div id="content" className="app-content box-shadow-z0" role="main">
          <Header pageTitle={'Disabled Employees'} {...this.props} />
