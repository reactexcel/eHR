...
const CalendarWeek = ({userId, dayData, onShowDaySummary}) => {
  let dayHtml = '';
  if (dayData.day_type === dayType.NON_WORKING_DAY) {
  ...
  } else if (dayData.day_type === dayType.LEAVE_DAY) {
  ...
  } else if (dayData.day_type === dayType.HALF_DAY) {
  ...
  } else if (dayData.day_type === dayType.FUTURE_WORKING_DAY) {
