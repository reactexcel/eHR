...
import DisplayUserBankDetails from 'src/components/manageUser/DisplayUserBankDetails';
import DisplayUserDeviceDetails from 'src/components/manageUser/DisplayUserDeviceDetails';
import UserPayslipsHistory from 'src/components/salary/managePayslips/UserPayslipsHistory';
import FormAddNewEmployee from 'src/modules/manageUsers/components/FormAddNewEmployee';
import AddSalaryForm from 'src/modules/salary/components/manageSalary/AddSalaryForm';
import FormAddNewEmployeeDetails from 'src/modules/manageUsers/components/FormAddNewEmployeeDetails';
import FormUserProfileDetails from 'src/modules/manageUsers/components/FormUserProfileDetails';
import EmployeeLifeCycle from 'src/modules/manageUsers/components/EmployeeLifeCycle';
