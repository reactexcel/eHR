  ...
  render() {
    return (
      <div>
        ...
        <Dialog title="Add New Employee" modal={false} open={this.state.open} onRequestClose={this.handleClose} contentStyle={{
          width: '70%',
          maxWidth: 'none'
          ...
          <table className="table">
            <tbody>
              <tr>
                <td>
                  Date of Joining
                  <DateField dateFormat="YYYY-MM-DD" onChange={(date) => {
              ...
              <tr>
                <td>
                  <TextField floatingLabelText="Name" floatingLabelFixed={true} fullWidth={true} onChange={(e) => (this.setState({name: e.target.value}))} value={this.state.name}/>

                </td>

                <td>
                  <TextField floatingLabelText="Job Title" floatingLabelFixed={true} fullWidth={true} onChange={(e) => (this.setState({jobtitle: e.target.value}))} value={this.state.jobtitle}/>
                </td>
              </tr>

              <tr>
                <td>
                  <TextField floatingLabelText="UserName" floatingLabelFixed={true} fullWidth={true} onChange={(e) => (this.setState({username: e.target.value}))} value={this.state.username}/>
                </td>

                <td colSpan={2}>
                  <TextField floatingLabelText="Work Email" floatingLabelFixed={true} fullWidth={true} onChange={(e) => (this.setState({workemail: e.target.value}))} value={this.state.workemail}/>
                </td>
              </tr>
