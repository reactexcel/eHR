  ...
  render() {
        ...
        <li key={key} className="list-group-item">
          <div className="clear b-t p-t">
            <div className="_500 block">{doc.document_type}
              <span className="glyphicon glyphicon-remove-circle pull-right" style={{
                fontSize: '12px',
                cursor: 'pointer'
              }} onClick={() => {
    ...
    return (
      <div>
        ...
        <Dialog title="Upload Employee Documents" modal={false} open={this.state.open} onRequestClose={this.handleClose} contentStyle={{
          width: '75%',
          maxWidth: 'none'
          ...
          <div>
            <form action={CONFIG.upload_url} method="POST" encType="multipart/form-data">
              ...
              <div className="form-group">
                ...
                <span style={styles.declearation}>
                  <b>*IMPORTANT:</b>
                  By uploading this document you certify that these document are true and all information is correct</span>
              </div>
              <div className="form-group">
