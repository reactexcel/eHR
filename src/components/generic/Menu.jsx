...
class Menu extends React.Component {
  ...
  render () {
    ...
    let linksToShow = <ul className="nav">
      ...
      <li className="hidden-folded"><span>{linkApplyLeave}</span></li>
      <li className="hidden-folded"><span>{linkHolidays}</span></li>
      <li className="hidden-folded"><span>{linkMyLeaves}</span></li>
      ...
      linksToShow = <ul className="nav">
        ...
        <li id="ManageSalary" onClick={() => { let s = 'ManageSalary'; this.click(s); }} className="">
          ...
          <ul className="nav-sub">
            ...
            <li className="hidden-folded"><span style={{'fontSize': 11, 'fontWeight': 600}}>{linkManagePayslips}</span></li>
          </ul>
        </li>
        ...
        <li className="hidden-folded"><span>{linkHolidays}</span></li>
        <li className="hidden-folded"><span>{linkInventorySystem}</span></li>
        <li className="hidden-folded"><span>{linkTeamView}</span></li>
        <li className="hidden-folded"><span>{linkLogout}</span></li>
      </ul>;
...
// Hr---
      ...
      linksToShow = <ul className="nav">
        <li className="hidden-folded"><span>{linkUsersList}</span></li>
        <li className="hidden-folded"><span>{linkManageWorkingHours}</span></li>
        <li className="hidden-folded"><span>{linkManageLeaves}</span></li>
        <li className="hidden-folded"><span>{linkManageUserWorkingHours}</span></li>
        <li className="hidden-folded"><span>{linkLeavesSummary}</span></li>
        <li className="hidden-folded"><span>{linkHolidays}</span></li>
        <li className="hidden-folded"><span>{linkLogout}</span></li>
      </ul>;
    }
