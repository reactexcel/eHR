        ...
        <div className="">
          <div className="row no-gutter m-b text-xs l-h-1x">
           ...
           <div className="col-xs-4 text-center" style={styles.cursor} onClick={ () => this.props.onApplyFilter('Pending') } >
            ...
            <div className="col-xs-4 text-center" style={styles.cursor} onClick={ () => this.props.onApplyFilter('Approved') } >
            ...
            <div className="col-xs-4 text-center" style={styles.cursor} onClick={ () => this.props.onApplyFilter('Rejected') } >
