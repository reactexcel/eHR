  ...
  return (
    <div className={`list-item b-l b-l-2x b-${leaveStatusColor}`}>
      ...
      <div className="list-body">
        ...
        <div className="text-ellipsis text-muted text-sm">Month : {leave.month}</div>
        {
          leave.leave_type !== ''
          ? <div className="text-ellipsis text-muted text-sm">Leave Type : {leave.type_text
          }</div>
          : null
        }
        {/* {
